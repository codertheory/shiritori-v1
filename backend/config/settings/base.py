...
MIGRATION_MODULES = {"sites": "shiritori.contrib.sites.migrations"}
...
ADMINS = [("""Lucas""", "lucas@coderthery.dev")]
...
CELERY_TASK_TIME_LIMIT = 60 * 60 * 20
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Shiritori API",
    "DESCRIPTION": "Documentation of API endpoints of the shiritori API",
    "VERSION": "1.0.0",
...
LOAD_DICTIONARY_KEY = env("LOAD_DICTIONARY_KEY", default="load_dictionary")
