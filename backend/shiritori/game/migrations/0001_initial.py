    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("word", "locale"), name="unique_word_locale"
            ),
        ),
        migrations.AddField(
            model_name="player",
        ...
        migrations.AddIndex(
            model_name="player",
            index=models.Index(
                fields=["game", "type"], name="player_game_id_9256ce_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="player",
            index=models.Index(
                fields=["game", "session_key"], name="player_game_id_d5f250_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="player",
            index=models.Index(
                fields=["game", "name"], name="player_game_id_8e0217_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="player",
            constraint=models.UniqueConstraint(
                fields=("game", "session_key"), name="unique_session_key"
            ),
        ),
        migrations.AddConstraint(
            model_name="player",
            constraint=models.UniqueConstraint(
                fields=("game", "name"), name="unique_name"
            ),
        ),
        migrations.AddConstraint(
            model_name="player",
            constraint=models.UniqueConstraint(
                condition=models.Q(("type", "HOST")),
                fields=("game", "type"),
                name="unique_host",
            ),
        ),
        migrations.AddIndex(
            model_name="gameword",
            index=models.Index(
                fields=["game", "player"], name="game_word_game_id_33ec00_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gameword",
            index=models.Index(
                fields=["game", "word"], name="game_word_game_id_93ffb9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gameword",
            index=models.Index(
                fields=["game", "score"], name="game_word_game_id_4e0b0c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="gameword",
            index=models.Index(
                fields=["player", "score", "word"], name="game_word_player__dac2d0_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="gameword",
