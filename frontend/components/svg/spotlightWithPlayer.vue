<template>
    ...
    >
        ...
        />
        <path
            d="M245.5 -120L489.286 499.5H1.71385L245.5 -120Z"
            fill="#FFF8B5"
            fill-opacity="0.14"
        />
        <foreignObject x="275" y="200" width="100%" height="100%">
            <div class="max-w-18rem">
                <InputFieldWord v-if="gameStore.isCurrentPlayerMe" />
            </div>
        </foreignObject>
        ...
        <rect
            ...
            height="51.3369"
            rx="12.2408"
            transform="rotate(-51.2186 335 395.084)"
            fill="black"
        />
        <rect
            x="371.93"
            ...
            width="10"
            height="27.5014"
            transform="rotate(40 371.93 390.415)"
            fill="#333334"
        />
    </svg>
</template>
